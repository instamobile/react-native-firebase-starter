package io.instamobile.rn.android.launchapplication;
...
public class LaunchApplicationModule extends ReactContextBaseJavaModule {
  ...
  //  Intent dialogIntent = new Intent(getReactApplicationContext(), MainActivity.class);
    Intent dialogIntent = getReactApplicationContext().getPackageManager().getLaunchIntentForPackage("io.instamobile.rn.android");
